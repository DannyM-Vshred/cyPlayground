@betaStaging @QA-923-3 @MD @landingPages
Feature: Create Greens orders via Sculptnation landing page
    Background: Load test data
        Given The user loads the LE test data
    @hotfixes
    Scenario: Create Greens subscription order on Keira Amazing Success Stories page section
        ...
        And The user clicks "Greens Favorite" bottle image 1 on the landing page
    ...
    Scenario: Create Greens one bottle order on Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Greens Favorite" bottle image 1 on the landing page
        ...
        When The user clicks the Proceed to Checkout button
        Then The user fills in the fields on the Checkout page and places the order
        And The user selects a flavor on the "first" upsell page
        And The user clicks the "Yes! Upgrade My Order" button on the "first" upsell page
        And The user selects One-time delivery price check box and clicks Add To Cart on the "second" upsell page
        And The user selects One-time delivery price check box and clicks Add To Cart on the "third" upsell page
        And The user clicks the "Yes! Upgrade My Order" button on the "fourth" upsell page
        Given The user logs into the SculptNation account
        Then The user validates the "one bottle" orders on the SculptNation Account Orders page
        And The user checks "Order Confirmation" email

    Scenario: Create Greens six bottle order on Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Greens Favorite" bottle image 1 on the landing page
    ...
    Scenario: Create Greens three bottle order on Keira Amazing Success Stories page section
        Given The user navigates to the SculptNation homepage
        When The user browses to "Amazing Success Stories" section of the landing page
        Then The user verifies that "Kiera" image exists
        And The user clicks "Greens Favorite" bottle image 1 on the landing page
