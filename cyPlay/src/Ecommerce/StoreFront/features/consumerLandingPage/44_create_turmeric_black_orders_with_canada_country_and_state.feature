@QA-2172 @QA-2173 @QA-2176 @BetaStaging @MD @landingPages
...
Feature: Create supplement orders via Sculptnation landing page with Canadian country and state
    ...
    Scenario: Create Turmeric Black order with Canadian country and state selected
        ...
        Then The user clicks "Turmeric Black" bottle image 1 on the landing page
