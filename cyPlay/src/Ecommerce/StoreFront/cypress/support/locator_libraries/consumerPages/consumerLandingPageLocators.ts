const consumerLandingPageLocators = {
    ...
    // Product page
    productPage: {
        clickToPlay: () => cy.get('.click-to-play'),
        privacyPolicyLink: () =>
            cy.get('[href="https://vshred.com/privacy-policy"]'),
        timeHolder: () => cy.get('.timer_holder > .container'),
        moneyBack: () => cy.findAllByText(/Money back guarantee/i).eq(0),
        ...
        declineRecipeGuide: () => cy.findAllByText(/No thanks. I don't want/i),
        declineBurn1B: () => cy.findAllByText(/NO, I WILL NOT ACCEPT/i),
        declineVsu: () => cy.findAllByText(/No thanks, I'll pass on this/i),
        ...
        upgradeOfferButton: () =>
            cy.contains(
                ...
                /add to my order|add to order|add to cart|click here|upgrade My Order|yes!|claim membership|now!|yes, I want this|Claim My FREE 30 Day Trial/i
            ),
    ...
    checkoutPage: {
        ...
        standardShipping: () =>
            cy.get('#__BVID__80 > :nth-child(1) > :nth-child(2)'),
        priorityShipping: () =>
            cy.get('#__BVID__80 > :nth-child(1) > :nth-child(1)'),
    ...
    checkoutFle: {
        contactDetails: {
            ...
            stateInt: () => cy.get('[for="billing_state"]'),
